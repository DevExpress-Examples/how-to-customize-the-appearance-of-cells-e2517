...
Namespace CustomAppearance
	Partial Public Class MainWindow
		...
		' Handles the CustomAppearance event. Sets the current cell's foreground color
		' to a color generated in a custom manner.
		Private Sub OnCustomAppearance(ByVal sender As Object, _
				ByVal e As PivotCustomAppearanceEventArgs)
		...
		Private Function IsValueNotFit(ByVal value As Decimal, _
				ByVal isGrandToatl As Boolean) As Boolean
		...
		Private Function GetColorByValue(ByVal value As Decimal, _
				ByVal isGrandTotal As Boolean) As Color
